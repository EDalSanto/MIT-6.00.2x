...
showPlot1("Time for each type of 1-10 robots to clean 80% of a room", "number of robots", "# of time_steps")

#
# 2) Write a function call to showPlot2 that generates an appropriately-labeled
#     plot.
#
#showPlot2("Time for 2 robots to clean 80% varying size", "aspect_ratios", "time_steps")
#
