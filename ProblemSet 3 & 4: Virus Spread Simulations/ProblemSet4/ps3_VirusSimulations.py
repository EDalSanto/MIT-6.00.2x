...
def simulationWithDrug(numViruses, maxPop, maxBirthProb, clearProb, resistances,
    ...
    """
    total_virus_populations = [[] for time_step in range(300)]
    guttagonol_resistant_viruses = [[] for time_step in range(300)]
    for trial in range(numTrials):
        viruses = []
        for virus in range(numViruses):
...
simulationWithDrug(75, 1000, .8, 0.1, {"guttagonol": True}, 0.8, 50)
